...
('http://nexthon.com/vmp', 1, 'Logo', 'Viral Media Portal', 'sample description here', 'sample keyword 1, sample keyword 2, sample keyword 3, sample keyword 4, sample keyword 5', 'logo.png', 'favicon.ico', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'nexthon@live.com', 1, 1, 'nexthon@live.com');
