		...
		<div class="main-filter ">
            <ul class="content-type">
					...
					<li><a class="current" href="<?php echo(rootpath()) ?>"><strong>All</strong></a></li>
						<?php if(rss_enable()) { ?>
							<li><a class="link" href="<?php echo(rootpath()) ?>/rss" style="padding-left: 8px; padding-right: 11px;"><img src="<?php echo(rootpath()) ?>/images/rss_icon.png"  /></a></li>
						<? } ?>
            ...
            <div id="sort">
				<label>
					...
					<select onchange="self.location=self.location='<?php echo(rootpath()) ?>/index.php?sort_by='+this.options[this.selectedIndex].value">
				...
				<a href="<?php echo(rootpath()) ?>/index.php?sort_order=DESC"><img src="<?php echo(rootpath()) ?>/images/arrow_up.png" title="Ascending"></a>
				<?php } else if($_SESSION['sort_order']=="DESC") { ?>
				<a href="<?php echo(rootpath()) ?>/index.php?sort_order=ASC"><img src="<?php echo(rootpath()) ?>/images/arrow_down.png" title="Descending"></a>
				 <? } else { ?>
				 <a href="<?php echo(rootpath()) ?>/index.php?sort_order=DESC"><img src="<?php echo(rootpath()) ?>/images/arrow_up.png" title="Ascending"></a>
				<?php } ?>
			</div>
